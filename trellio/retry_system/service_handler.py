#does the work of pinger and more
...
class ServiceRetrySystem:
    """
    to send ping packets to services and restart/log/cleanup when down
    """
...
class HTTPPinger:
    ...
    def on_timeout(self):#this method is called for max_failures
